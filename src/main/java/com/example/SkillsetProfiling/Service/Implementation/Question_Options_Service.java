...
//        if (questionOptionsRepo.findById(questionBankRepo.findById(questionOptions.getQuestionID().getQuestionID()).get()).isPresent())
...
//        Optional<Question_Options> questionOptionsOptional = questionOptionsRepo.findById(questionBankRepo.findById(questionID).get());
//
...
//        Optional<Question_Options> existingQuestionOptionsOptional = questionOptionsRepo.findById(questionBankRepo.findById(questionID).get());
//
...
//
//        if (questionOptionsOptional.isPresent()) {
//            questionOptionsRepo.deleteById(questionBankRepo.findById(questionID).get());
